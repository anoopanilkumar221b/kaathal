...
# Directory where static files will be collected for production (not needed for dev, but useful for deployment)
...
EMAIL_HOST_USER = 'anoopanilkumarmararikulam@gmail.com'  # Your Gmail address
EMAIL_HOST_PASSWORD = 'bcms sdxq fdpk erfc'  # The app password you created
